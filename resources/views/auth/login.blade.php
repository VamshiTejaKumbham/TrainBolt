    ...
    <form method="POST" action="{{ route('login') }}" >
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded dark:bg-black border-black-300 dark:border-black text-white-600 shadow-sm focus:ring-white-500 dark:focus:ring-white-600 dark:focus:ring-offset-black-800" name="remember">
